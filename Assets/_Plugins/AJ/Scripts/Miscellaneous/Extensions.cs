...
public static class Extensions {
    ...
    {
        return new Color(a.r/2 + b.r/2, a.g/2 + b.g/2, a.b/2 + b.b/2, a.a/2 + b.a/2);
    }

    public static Color GetRandomPastelColor()
    {
        return MixColors(GetRandomColor(), Color.white);
    }

    public static Color GetRandomPastelColor(int seed)
    {
